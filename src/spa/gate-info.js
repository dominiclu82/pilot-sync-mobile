...
var _giRegions = {
  ...
  US: { name: 'US', stations: [ { code: 'SFO', name: '舊金山', src: 'sfo', tz: 'America/Los_Angeles' }, { code: 'LAX', name: '洛杉磯', src: 'lax', tz: 'America/Los_Angeles' }, { code: 'PHX', name: '鳳凰城', src: 'phx', tz: 'America/Phoenix' }, { code: 'SEA', name: '西雅圖', src: 'sea', tz: 'America/Los_Angeles' }, { code: 'ONT', name: '安大略', src: 'ont', tz: 'America/Los_Angeles' } ] },
