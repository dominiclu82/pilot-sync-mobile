...
var _giRegions = {
  ...
  JP: { name: 'JP', stations: [ { code: 'NRT', name: '成田', src: 'nrt', tz: 'Asia/Tokyo' }, { code: 'CTS', name: '新千歲', src: 'cts', tz: 'Asia/Tokyo' }, { code: 'HKD', name: '函館', src: 'hkd', tz: 'Asia/Tokyo' }, { code: 'KIX', name: '大阪', src: 'kix', tz: 'Asia/Tokyo', dev: true, todayOnly: true }, { code: 'FUK', name: '福岡', src: 'fuk', tz: 'Asia/Tokyo', dev: true, todayOnly: true }, { code: 'SDJ', name: '仙台', src: 'sdj', tz: 'Asia/Tokyo', dev: true, todayOnly: true } ] },
