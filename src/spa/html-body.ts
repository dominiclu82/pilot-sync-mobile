...
<div class="tab-bar">
  ...
  <div class="tab-btn tab-util" style="flex-direction:row;gap:0">
    ...
    <div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px">
      ...
      <span style="font-size:.55em;color:var(--muted);line-height:1;opacity:.7;cursor:pointer;text-decoration:underline" onclick="showAbout()">V9.5.28</span>
    </div>
  </div>
</div>
...
<div id="about-overlay" class="install-overlay" style="display:none" onclick="if(event.target===this)closeAbout()">
  <div class="install-card">
    ...
    ${renderCommunityLink()}
    <div style="font-size:.78em;font-weight:700;margin-bottom:6px" id="about-version">V9.5.28</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>✈️ <b>Gate Info 修正過境班（如 TR866 SIN→TPE→NRT）顯示錯誤，現在正確拆成到站和離站兩筆。</b></div>
      <div>✈️ <b>Gate Info: transit flights (e.g. TR866 SIN→TPE→NRT) now show as two separate rows instead of one garbled entry.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.27</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
    ...
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.25</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
    ...
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.22</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🗼 <b>後台優化。</b></div>
      <div>🗼 <b>Admin backend improvements.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.21</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🗼 <b>後台管理優化。</b></div>
      <div>🗼 <b>Admin backend improvements.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.20</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>⛅ <b>Airport WX：ATIS 改為按「更新」才載入。</b></div>
      <div>⛅ <b>Airport WX: ATIS now loads only when you tap refresh.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.19</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🛬 <b>Gate Info 表頭排版修正；修復返回鈕偶爾消失。</b></div>
      <div>🛬 <b>Fixed Gate Info header layout & the home button occasionally vanishing.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.18</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
    ...
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.16</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🛬 <b>外站往返台北的航班，自動補上台北端登機門等資訊。</b></div>
      <div>🛬 <b>Outstation flights to/from Taipei now show the Taipei-side info too.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.15</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🛬 <b>Gate Info 新增 大阪、福岡、仙台 三站。</b></div>
      <div>🛬 <b>Added Osaka, Fukuoka & Sendai to Gate Info.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.14</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🛬 <b>Gate Info 新增 曼谷、清邁 兩站。</b></div>
      <div>🛬 <b>Added Bangkok & Chiang Mai to Gate Info.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.13</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🛬 <b>Gate Info 新增 台中。</b></div>
      <div>🛬 <b>Added Taichung to Gate Info.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.12</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🛬 <b>Gate Info 新增 松山。</b></div>
      <div>🛬 <b>Added Taipei Songshan to Gate Info.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.11</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🛬 <b>Gate Info 新增 香港、高雄 兩站。</b></div>
      <div>🛬 <b>Added Hong Kong & Kaohsiung to Gate Info.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.10</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🛬 <b>更改顯示用語。</b></div>
      <div>🛬 <b>Updated wording.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.09</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🛬 <b>修正 Gate Info 外站跨時區日期判斷（美國/歐洲時段性讀不到資料）。</b></div>
      <div>🛬 <b>Fixed cross-timezone date handling for outstations.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.08</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🛬 <b>改進 Gate Info 資料抓取方式。</b></div>
      <div>🛬 <b>Improved Gate Info data fetching.</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.07</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
      <div>🛬 <b>Gate Info 新增外站:鳳凰城、西雅圖、安大略(實驗中)。</b></div>
      <div>🛬 <b>Gate Info: added Phoenix, Seattle, Ontario (experimental).</b></div>
    </div>
    <div style="font-size:.78em;font-weight:700;color:var(--muted);margin-bottom:6px">V9.5.06</div>
    <div style="font-size:.72em;color:var(--muted);margin-bottom:10px;line-height:1.5;text-align:left">
