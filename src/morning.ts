...
<div class="modal-wrap" id="about-wrap" onclick="if(event.target===this)hideAbout()">
  <div class="modal">
    ...
    <div class="changelog-v old">V1.3.01</div>
    <div class="changelog-txt">
      台灣新聞分類拖移排序 + 跨裝置同步：10 大分類可長按拖移改順序，順序存 server，換裝置也同步。<br>
      TW news categories now reorderable via long-press drag; order synced to server for cross-device consistency.
    </div>
    <div class="changelog-v old">V1.3.00</div>
    <div class="changelog-txt">
      台灣新聞改為 10 大分類（熱門/娛樂/股市/國際/天氣/玩樂/理財/電影/時尚/健康），每類收集 30 條，每類可收合展開。<br>
      TW news reorganized into 10 categories (popular/entertainment/stocks/international/weather/leisure/finance/movies/fashion/health), 30 articles each, collapsible per category.
    </div>
    <div class="changelog-v old">V1.2.04</div>
    <div class="changelog-txt">
